...
| -- | 2026-08-17 | ADR 006 profiles: `iacs_enip`, `iacs_bacnet_sc`, `iacs_dnp3`, `iacs_iec61850`. Same peek-then-passthrough gate; Inspect classifies Cmd on EIP Set / DNP3 Operate / MMS Write. BACnet/SC confirms TLS only. Staging: [iacs_protocol_profiles_smoke_test.md](iacs_protocol_profiles_smoke_test.md). |
