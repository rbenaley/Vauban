...
| [Session Recording Architecture](docs/technical/Vauban_Recording_Architecture_EN(1.4).md) | RDP segmented fMP4 + SSH asciicast v2 + IACS PCAP bundle (`pcap-bundle`), input redaction, DASH/asciinema playback, ZIP download |
