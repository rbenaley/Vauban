...
| [LDAPS Auth Architecture](docs/technical/Vauban_LDAPS_Auth_Architecture_EN(1.1).md) | Directory-backed login, LDAPS bind via vauban-auth, JIT provisioning, User Group aggregation (`static` / `match` mapping file), anti-downgrade |
