...
| [Session Recording Architecture](docs/technical/Vauban_Recording_Architecture_EN(1.0).md) | Fragmented MP4 recording, BLAKE3 integrity, HTTP Range streaming, playback |
